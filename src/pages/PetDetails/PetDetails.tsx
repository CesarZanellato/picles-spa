...
import { getPetById } from "../../services/pets/get.pets.by.id";
            ...
            <>
              ...
              {!petIsError && (
                <>
                  ...
                  <p>{petData?.bio}</p>
                  {   
                    !shelterIsError && <a href={`https://wa.me/${shelterData?.shelterWhatsApp}?text=olá, gostaria de falar sobre o ${petData?.name}`}>
